  ...
  "group/card flex flex-col gap-4 overflow-hidden rounded-none bg-card py-4 text-xs/relaxed text-card-foreground has-data-[slot=card-footer]:pb-0 has-[>img:first-child]:pt-0 data-[size=sm]:gap-2 data-[size=sm]:py-3 data-[size=sm]:has-data-[slot=card-footer]:pb-0 *:[img:first-child]:rounded-none *:[img:last-child]:rounded-none",
  {
    variants: {
      variant: {
        ...
        ghost: "ring-0 border-none shadow-none bg-transparent",
        login: "ring-0 border-none bg-transparent text-white relative w-full max-w-md animate-in fade-in slide-in-from-right-8 duration-700",
      },
    },
    defaultVariants: {
      variant: "default",
